  ...
  return (
    <AuthCheck>
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <SearchBar initialQuery={searchQuery} postType="blog" />
        </div>
        <div className="mb-8">
          <h2 className="text-xl font-semibold mb-4">Categories</h2>
          <div className="flex flex-wrap gap-2">
            <Link href="/content-manager/blog" passHref>
            ...
            {categories.map((category) => (
              <Link
                key={category.id}
                href={`/content-manager/blog?category=${category.id}`}
                passHref
              >
                <Button
                  variant={
