...
export default function CategoryManager() {
  ...
  const [categoryType, setCategoryType] = useState<"blog" | "news">("blog");
  const {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <Select
          value={categoryType}
          onValueChange={(value: "blog" | "news") => setCategoryType(value)}
        >
          <SelectTrigger>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-semibold mb-2">Blog Categories</h3>
            ...
            {blogCategories.map((category) => (
              ...
              >
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => handleDeleteCategory(category, "blog")}
                >
                  Delete
                </Button>
              </li>
