...
export default function Header() {
  ...
  return (
    <header className="font-montserrat absolute top-0 z-50 w-full bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/60">
      ...
      {isMenuOpen && (
        <nav className="md:hidden px-4 py-2 bg-background">
          {NavigationLinks.map((link) => (
            <Link
              key={link.label}
              href={link.href}
